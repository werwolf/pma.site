...
<head>
    ...
    <script src="http://<?=$_SERVER['HTTP_HOST'];?>/static/elfinder/jquery-1.4.1.min.js" type="text/javascript" charset="utf-8"></script>    
    ...
    <script src="http://<?=$_SERVER['HTTP_HOST'];?>/static/elfinder/jquery-ui-1.7.2.custom.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="http://<?=$_SERVER['HTTP_HOST'];?>/static/elfinder/elfinder.min.js" type="text/javascript" charset="utf-8"></script>
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST'];?>/static/elfinder/ui-themes/base/ui.all.css" type="text/css" media="screen" title="no title" charset="utf-8"/>
    <link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST'];?>/static/css/elfinder.css" type="text/css" media="screen" title="no title" charset="utf-8"/>
