...
--
-- Хост: localhost
-- Время создания: Апр 16 2010 г., 22:34
...
CREATE TABLE IF NOT EXISTS `Ratings` (
  ...
  `Groupe_ID` int(10) unsigned NOT NULL,
  `DopProf_ID` int(10) unsigned NOT NULL,
  `Subject_ID` int(10) unsigned NOT NULL,
  `Max_Rating` int(6) NOT NULL,
  PRIMARY KEY  (`ID`),
  KEY `Professor_ID` (`Professor_ID`,`Groupe_ID`,`DopProf_ID`,`Subject_ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
(1, 'vanish', 'scripka', 'andreich', 'vanish', 'e3571bfa766e709908f403f0461e169e', 'vanish.com@mal.ru', 'M', '2010-05-20', '', 503965771, 'rock_tux.png', 'P', '', 'ua', '74c58910a2265610902d570506a0b62e', '95.132.166.112');
