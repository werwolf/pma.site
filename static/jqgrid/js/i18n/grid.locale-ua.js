	...
	a.jgrid = {
		...
		edit: {
			...
			msg: {
				...
				minValue: "значення повинне бути не менше за",
				maxValue: "значення повинно бути не більше за",
				email: "некоректна адреса електронної пошти",
				integer: "Будь ласка, введіть правильне ціле значення",
				date: "Будь ласка, введіть коректну дату",
				url: "не дійсний URL. Необхідна приставка ('http://' or 'https://')",
				nodefined: " невизначено!",
				novalue: " необхідно ввести значення!",
				customarray: "Custom-функція повинна повертати масив!",
				customfcheck: "Відмічено власну перевірку даних, але custom-функцію не задано!"
			}
		},
		view: {
