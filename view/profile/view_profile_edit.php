    ...
    <table class="user_data">
        <tr>
            <td colspan="2" valign="top">
                <? if(file_exists("static/uploaded/user_photo/".$user->getUserPhoto()) && strlen($user->getUserPhoto()) > 0):?><img src="http://<?=$_SERVER['HTTP_HOST'];?>/static/uploaded/user_photo/<?=$user->getUserPhoto();?>" style="margin-bottom:20px"/><?endif;?><br/>
        ...
        <tr>
            ...
            <td><input type="text" style="width:200px" name="surname" value="<?=$user->getUserSurname();?>" readonly/></td>
        </tr>
        <tr>
            <td><?=$labels['profile']['name'];?></td>
            <td><input type="text" style="width:200px" name="name" value="<?=$user->getUserName();?>" readonly/></td>
        </tr>
        <tr>
            <td><?=$labels['profile']['patronymik'];?></td>
            <td><input type="text" style="width:200px" name="patronymik" value="<?=$user->getUserPatronymic();?>" readonly/></td>
        </tr>
        <tr>
